...
public class TargetLocation {
    ...
    public static final TargetLocation RED_H = new TargetLocation(10, VisionInput.Camera.SIDE);
    public static final TargetLocation RED_G = new TargetLocation(10, VisionInput.Camera.TOP);
    public static final TargetLocation RED_F = new TargetLocation(9, VisionInput.Camera.SIDE);
    public static final TargetLocation RED_E = new TargetLocation(9, VisionInput.Camera.TOP);
    ...
    public static final TargetLocation RED_J = new TargetLocation(11, VisionInput.Camera.SIDE);
    public static final TargetLocation RED_I = new TargetLocation(11, VisionInput.Camera.TOP);

    public static final TargetLocation BLUE_H = new TargetLocation(21, VisionInput.Camera.SIDE);
    public static final TargetLocation BLUE_G = new TargetLocation(21, VisionInput.Camera.TOP);
    public static final TargetLocation BLUE_F = new TargetLocation(22, VisionInput.Camera.SIDE);
    public static final TargetLocation BLUE_E = new TargetLocation(22, VisionInput.Camera.TOP);
    ...
    public static final TargetLocation BLUE_J = new TargetLocation(20, VisionInput.Camera.SIDE);
    public static final TargetLocation BLUE_I = new TargetLocation(20, VisionInput.Camera.TOP);
}
