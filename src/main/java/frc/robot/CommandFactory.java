...
public class CommandFactory {
  ...
  public CommandFactory(SubsystemManager subsystemManager, OdometryProcessor odometry) {
    ...
    NamedCommands.registerCommand("MoveFromScoreAndDealgiyL2Left", new AutoDealgifyCommand(RobotIO.getInstance(), subsystemManager.getDriveSubsystem(), subsystemManager.getCoralMechanismSubsystem(), this, Position.L2, "right"));
    var alliance = DriverStation.getAlliance();
