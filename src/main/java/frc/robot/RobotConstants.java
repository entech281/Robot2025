...
public final class RobotConstants {
  ...
  public static interface AccelerationFilter {
    public static final double DIRECTION_SLEW_RATE = 0.75; // radians per second
    public static final double MAGNITUDE_SLEW_RATE = 0.75;
  ...
  public static interface LiveTuning {
    public static final Map<String, Double> VALUES = Map.ofEntries(
      ...
      Map.entry(Position.L1.getElevatorKey(), 2.0),
      Map.entry(Position.L2.getElevatorKey(), 4.7),
      Map.entry(Position.L3.getElevatorKey(), 10.0),
      Map.entry(Position.L4.getElevatorKey(), 19.5),
      ...
      Map.entry(Position.ALGAE_L2.getPivotKey(), 143.0),
      Map.entry(Position.ALGAE_L3.getPivotKey(), 143.0),
      Map.entry(Position.L1.getPivotKey(), 30.0),
      ...
      Map.entry(Position.FLICK_LEVEL.getPivotKey(), 80.0),
